...
from metrics.complaint.repeat_rate import QLY, run_metric


def main() -> None:
    parser = argparse.ArgumentParser(description="从数据库计算千里眼重复投诉率")
    ...
    report = run_metric(QLY, args.database, args.start_date, args.end_date, args.mode, args.output)
